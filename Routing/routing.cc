...
namespace operations_research {
	...
	void readInput(DataModel* _data, int* metaheuristic) {
		
		// TODO: Change input to read from JSON - input is currently hardcoded
		_data->distance_matrix = {
	  ...
	  0, 1, 1, 2, 4, 2, 4, 8, 8, 1, 2, 1, 2, 4, 4, 8, 8 };
		...
		_data->vehicle_capacities = { 15, 15, 15, 15 };
		_data->num_vehicles = 4;
		metaheuristic = &3;
	}
...
int main(int argc, char** argv) {
	...
	int metaheuristic = -1;
	operations_research::readInput(&data);
