...
/* harmony import */ var _agm_markerclusterer__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! @agm/markerclusterer */ "./node_modules/@agm/markerclusterer/__ivy_ngcc__/fesm2015/agm-markerclusterer.js");
...
(function () { (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_1__["ɵɵsetNgModuleScope"](AppModule, { declarations: [_app_component__WEBPACK_IMPORTED_MODULE_24__["AppComponent"],
        ...
        _angular_material_select__WEBPACK_IMPORTED_MODULE_18__["MatSelectModule"],
        _angular_material_slide_toggle__WEBPACK_IMPORTED_MODULE_19__["MatSlideToggleModule"],
        _angular_material_dialog__WEBPACK_IMPORTED_MODULE_20__["MatDialogModule"], _agm_core__WEBPACK_IMPORTED_MODULE_21__["AgmCoreModule"], _agm_markerclusterer__WEBPACK_IMPORTED_MODULE_22__["AgmMarkerClustererModule"]] }); })();
...
class RoutefetcherService {
    ...
    getAllRoutes() {
        ...
        return this.http.get(this.routesUrl)
            .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["map"])(convertRawRoot), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_2__["catchError"])(Object(_httpHelpers__WEBPACK_IMPORTED_MODULE_3__["handleError"])('getAllRoutes')));
    }
}
...
function convertRawRoot(nav) {
    ...
    nav.binCollectionSchedules.forEach(x => x.routes.forEach(y => y.directions.forEach(z => {
        // @ts-ignore
...
class ViewRoutesComponent {
    ...
    setupRenderer() {
        ...
        */
        ...
        console.log(google.maps.geometry.encoding.decodePath(this.all_routes.binCollectionSchedules[0].routes[0].directions[0].routes[0].overview_polyline));
    }
}
